...
export function InteractiveRating({ ratings, currentUserId, onRatingChange }: InteractiveRatingProps) {
    ...
    const handleClick = (starValue: number, event: React.MouseEvent<HTMLButtonElement>) => {
    ...
    const handleHover = (starValue: number, event: React.MouseEvent<HTMLButtonElement>) => {
