...
export function BookSearch({ searchQuery, onSearchChange, resultsCount, totalCount }: BookSearchProps) {
    return (
        <div>
            {/* Search Field */}
            ...
            {/* Search Results Info */}
            {searchQuery.trim() && resultsCount !== undefined && totalCount !== undefined && totalCount > 0 && (
