...
import { ReadingStatus, ReadingStatusLabels, type ReadingStatusValue } from '../../types'
...
const StatusDropdown: React.FC<StatusDropdownProps> = ({ value, onChange, disabled = false }) => {
